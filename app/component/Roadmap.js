    ...
    <>
      <div>
        <div className="flex justify-center mx-auto">
          <div className="lg:w-[1280px] flex justify-end">
            <div className="flex">
              <Image
                src={forwarded}
                alt="image"
              ...
              <Image
                src={bars2}
                alt="image"
                className="-mb-[16%] lg:-mb-[5%]"
              />
            </div>
          </div>
        </div>
        <div className="flex justify-center flex-col text-white items-center mx-auto mt-[00px] pt-[35px] pb-[61px] mb-[80px] bg-[#4F1763] ">
          <div className="lg:w-[1280px]">
            ...
            <div className="space-y-5 lg:w-[90%] mx-auto mt-[20px] lg:mt-[33px]">
